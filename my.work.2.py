############### 1
my_list = [-8, True, 92, 'True', 11.1, None, 0, (12, 4, "ad")]
def my_type(el):
...
el = 0
while i < el_count:
     my_list.append(input("Введите следующее значение списка "))      #пока i меньше эл списка (el_count), добавляете зн в спис (my_list)
     i += 1
